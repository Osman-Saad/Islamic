...
@Composable
fun AzkarItem(azkar:Any,azkatype:String,azkarNumber:Int){
    ...
    val textWithIcon = buildAnnotatedString {
        ...
        append("\n")
        val zekrText = when (azkar) {
            is AzkarSabahItem -> azkar.zekr
            is AzkarMassaItem -> azkar.zekr
            else -> ""
        }
        append(zekrText?:"")
    }
    ...
    val inlineContent = mapOf(
        "icon" to InlineTextContent(
            ...
            Box(
                ...
                Text(
                    text = NumberFormat.getInstance(Locale("ar")).format(azkarNumber),
                    color = Gold,
